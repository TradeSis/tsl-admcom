...
def var hpedidoVendaMercadoriaEntrada          as handle.
def var hpedidoVendaMercadoriaSaida            as handle.
  
DEFINE TEMP-TABLE ttpedidoVendaMercadoria NO-UNDO SERIALIZE-NAME "pedidoVendaMercadoria"
        field id as char
        field tstatus as char serialize-name "status"
        field tipoPedido as char
...
DEFINE DATASET pedidoVendaMercadoriaEntrada FOR ttpedidoVendaMercadoria, 
 ttcliente, ttendereco, ttcontato, tttelefones, 
 ttitens, ttgarantias, ttdescontos , ttcampanhas, ttfrete,
ttrecebimentos , ttcartaoLebes, ttcontrato, ttparcelas, ttseguro, ttcartaoPresente, ttcartaoDebito, ttvaleTrocaGarantida, ttcartaoCredito, ttvaleTroca, ttcheque
    , ttpixdebito
  DATA-RELATION for4 FOR ttpedidoVendaMercadoria, ttcliente  RELATION-FIELDS(ttpedidoVendaMercadoria.id,ttcliente.idpai) NESTED
  ...
  DATA-RELATION for5 FOR ttpedidoVendaMercadoria, ttitens  RELATION-FIELDS(ttpedidoVendaMercadoria.id,ttitens.idpai) NESTED
  ...
  DATA-RELATION for6 FOR ttpedidoVendaMercadoria, ttfrete  RELATION-FIELDS(ttpedidoVendaMercadoria.id,ttfrete.idpai) NESTED
  DATA-RELATION for1 FOR ttpedidoVendaMercadoria, ttrecebimentos  RELATION-FIELDS(ttpedidoVendaMercadoria.id,ttrecebimentos.idpai) NESTED
...
hpedidoVendaMercadoriaEntrada = DATASET pedidoVendaMercadoriaEntrada:HANDLE.

/*
/* SAIDA */
DEFINE TEMP-TABLE ttstatus NO-UNDO serialize-name 'pedidoVendaMercadoriaSaida'
...
hpedidoVendaMercadoriaSaida = DATASET conteudoSaida:HANDLE.
*/
