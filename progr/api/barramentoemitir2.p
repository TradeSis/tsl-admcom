...
def output param par-base64Boleto as char.
vstatus = "N".
...
put unformatted
    "curl -s ~"http://localhost/bsweb/api/boleto/barramentoEmitir2" + "~" " +
...
for each ttreturn where ttreturn.pstatus = "".
    ...
    then do:
        ...
        then do on error undo:
            ...
            */
            par-base64Boleto    = ttreturn.base64Boleto .
            vstatus = "S".
