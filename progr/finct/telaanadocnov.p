...
/*04082021 helio - ajustado cobcod do contrato novo */
{admcab.i}
    ...
    for each ttpdvmov.
        ...
        then do:
            ...
            for each pdvdoc of pdvmov 
                ...
                release cobra.
                find contrato where contrato.contnum = int(pdvdoc.contnum)
                    no-lock.
        ...
        vbaru = avail btitulo.
                ...
                put unformatted
                    ...
                    if avail cobra then cobra.cobcod else ""  vcp
                    if avail cobra then cobra.cobnom else "" vcp
                    vvlf_acrescimo vcp
