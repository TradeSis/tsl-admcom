...
DEF OUTPUT PARAM    varqpagamentos          AS CHAR.
...
END.
v-relatorio-geral = ttparametros.relatorio-geral.        
 ...
 v-feirao-nome-limpo = ttparametros.feirao-nome-limpo.
    ...
    */
    ...
    varqpagamentos = vdir + "cre02_resumomensal_pagamentos_" + string(today,"99999999") + "_" + replace(string(vtime,"HH:MM:SS"),":","") + ".csv".
...
"Parcela;Emissao;Valor;Vencimento;Cobrador;" "Pagamento;Parcial;TBai;DescTipobaixa;Pago;Juro"
    ...
    varqjuro = vdir + "cre02_resumomensal_porcliente_" + string(today,"99999999") + "_" + replace(string(vtime,"HH:MM:SS"),":","") + ".csv".
    ...
    ELSE DO:
        varquivo = "cre02_resumomensal_" + string(setbcod) + "-" + STRING(TODAY,"99999999") +
                        replace(STRING(TIME,"HH:MM:SS"),":","").
    END.
