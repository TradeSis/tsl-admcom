...
/* helio 18082022 -  rollback produitos adm + ID 131236 - Ajuste Arquivo de Importa��o */
...
procedure p-registro-00.
     ...
     put unformat skip
         ...
         "0001"    /* 19 - 22 NUM�RICO        AG�NCIA ??? */
         "LEBES" format "x(6)" /* 23 - 28 ALFANUM�RICO    LOJISTA ??? */
...
put unformat skip
    ...
    (if clien.estciv > 0 and clien.estciv < 6
     ...
     "  "         /* 195 - 196  org�o emissor */
     "00000000"   /* 197 - 204   DATA    DATA EMISS�O  */  
     "0"          /* 205 - 205    GRAU DE INSTRU��O */
     "C"          /* 206 - 206 TP CLIENTE C-Cliente  A-Avalista O-Coobr */
     "  "         /* 207 - 208 UF DOC IDENTIDADE */
     "  "         /* 209 - 210 C�digo do Conceito do cliente */
     " " format "x(584)"
     vseq format "999999".
...
assign
    ...
    /*#16092022 se a data estivar vazia ou invalida, incluir a data da opera��o realizada. */
...
put unformat skip 
   "02"  
    ...
    RemoveAcento(vnomconj) format "x(40)"    /* 17 - 56 NOME DO C�NJUGE  */
...
procedure p-registro-03.
  ...
  put unformat skip "03" 
      ...
      " " format "x(20)"  /* 46 - 65 ALFANUM�RICO    AG�NCIA BANCO2 */
      "000"     /* 66 - 68 NUM�RICO    CARTAO CREDITO1 VER ANEXO */
      "00"      /* 69 - 70 NUMERICO    TIPO CARTAO1    */
      "000"     /* 71 - 73 NUM�RICO    CARTAO CREDITO2   */
      "00"      /* 74 - 75 NUM�RICO    TIPO CARTAO2      */
      ...
      " " format "x(579)" /* 216 - 794   ALFANUM�RICO    FILLER  */
...
procedure p-registro-04.
  ...
  put unformat skip "04"  /* 01  - 02  TIPO  FIXO � 04*/
      clien.endereco[1]  format "x(50)" /* 03 - 52   ENDERE�O */
  ...
  put unformat 
      ...
      " " format "x(40)" /* 232 � 271 ENDERE�O ALTERNATIVO  */
      " " format "x(40)" /* 272 � 311 BAIRRO ENDERE�O ALTERNATIVO*/    
      " " format "x(40)" /* 312 � 351 CIDADE ENDERE�O ALTERNATIV */   
      " " format "x(2)"  /* 352 � 353 UF ENDERE�O ALTERNATIV */
      " " format "x(8)"  /* 354 � 361 CEP ENDERE�O ALTERNATIVO*/
      fill("0",17)       /* 362 � 378 ALUGUEL MENSAL    Clien.*/
      fill("0",17)       /* 379 � 395 PRESTA��O CASA PR�PRIA*/
      fill(" ",399)      /* 396  794   ALFANUM�RICO    FILLER  */
      vseq format    "999999" /*795 - 800 */ .
end procedure.
...
procedure p-registro-10.
  ...
  find first titulo where titulo.contnum = contrato.contnum and
    ...
    then do:      
        ...
        if avail contrsite 
        then do: 
            vcod-produto = 13. /* 06042021 helio - Credi�rio Digital . Int. Financeira - Codigo produto */
        end.
    end.
    ...
    /* ID 139269 - ADMCOM - "PRINCIPAL" CONTENDO Valores/Exporta��o de arquivo PRINCIPAL=0 */
  ...
  put unformat skip 
      ...
      vdtinicial format "99999999"  /* 42-49 DATA EMISS�O */
      ...
      */
      ...
      ((vtitvltot /*- titulo.titdesc*/) * 100) format "999999999999999999" /* 75-92 VALOR PRESTA��O */
...
/* LIBERA��O PARA O CLIENTE (Obrigat�rio para empr�stimo Pessoal) */
PROCEDURE p-registro-12.
    ...
    /* helio 16122021 - Chamado 101510 - 75460 - Altera��o CPF arquivo Financeira 
...
procedure p-registro-13:
    ...
    for each ttnovacao where ttnovacao.tipo = "ORIGINAL".
        ...
        put unformat skip
        "13"                   /* 01-02 fixo "13" */
        dec(ttnovacao.contnum) format "9999999999" /* 03 - 12 OPERA��O */
        "0001"                            /* 13 - 16 AG�NCIA */
        (ttnovacao.valor * 100)
...
procedure p-registro-99.
  ...
  put unformat skip
     ...
     vqtoper format "9999999999"          /* 19-28 QTD DE OPERA��ES */
     vtotal  format "99999999999999999"   /* 29-45 VLR TOTAL das OPERA��ES */
